...
class HODController extends Controller
{
    public function index(){
        ...
        return view('admin.hod', ['hod'=> $staffs, 'departements'=> $departements]);
    }

    public function generalList(){
        // $staffs = [];
        $staffs= User::whereRoleIs('hod')->get();
        return response()->json(['hod' => $staffs], 200);
    }
    ...
    public function show($id)
    {
        ...
        return response()->json(['hod'=>$staffs]);
    }
    ...
    //             return response()->json(['result' => "ok", 'extra_message' => 'departement has active hod'], 200);
    //             }
    //             else{
