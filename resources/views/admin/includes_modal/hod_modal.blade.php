    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <fieldset>
                ...
                <form id="frmUpdate" class="form-horizontal" method="POST" action="{{route('admin.hod.update')}}">
                @csrf
...
<div class="modal fade" id="addnew">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalCenterTitle">Add HOD</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
            </div>
            ...
            <fieldset>
                ...
                <form id="frmSave" class="form-horizontal" method="POST" action="{{route('admin.hod.create')}}">
                @csrf
                ...
                <input type="hidden" name="is-hod" value="hod">
