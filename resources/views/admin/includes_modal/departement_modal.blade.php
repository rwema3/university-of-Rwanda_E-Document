...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalCenterTitle">Edit departements</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
            </div>
            ...
            <fieldset>
                <legend>Departement Info</legend>
                ...
                <form id="frmUpdate" class="form-horizontal" method="POST" action="{{route('admin.departements.update')}}">
                @csrf
                <div id="entry_1" class="form-group row form-content">
                    <label for="edit_departement_name" class="col-sm-4 control-label">departement Name</label>

                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="edit_departement_name" name="edit_departement_name" required>
                    </div>
...
<div class="modal fade" id="addnew">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalCenterTitle">Add departement</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
            </div>
            ...
            <fieldset>
                ...
                <form id="frmSave" class="form-horizontal" method="POST" action="{{route('admin.departements.create')}}">
                @csrf
                <div  class="entry_0 form-group row form-content">
                    <label for="college_id" class="col-sm-4 control-label">Choose College</label>
                ...
                <div  class="entry_0 form-group row form-content">
                    <label for="school_id" class="col-sm-4 control-label">Choose School</label>
                ...
                <div id="" class="entry_1 form-group row form-content">
                    <label for="departement_name" class="col-sm-4 control-label">Departement Name</label>
