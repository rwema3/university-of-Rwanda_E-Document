...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalCenterTitle">Edit Staff</h5>
            ...
            <fieldset>
                ...
                <form id="frmUpdate" class="form-horizontal" method="POST" action="{{route('admin.staffs.update')}}">
                @csrf
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <fieldset>
                ...
                <form id="frmSave" class="form-horizontal" method="POST" action="{{route('admin.staffs.create')}}">
                @csrf
